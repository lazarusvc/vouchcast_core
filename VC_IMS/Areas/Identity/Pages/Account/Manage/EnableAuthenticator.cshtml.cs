...
namespace VC_IMS.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(VC_user user)
        {
            ...
            // Now render a PNG QR code with QRCoder
            var issuer = _configuration["App:Name"] ?? "VC_IMS";
